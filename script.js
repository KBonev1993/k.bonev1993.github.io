            ...
            commandOutput.innerHTML = `
                ...
                <div class="skills-icons">
                    <a href="https://skillicons.dev" target="_blank">
                        <img src="https://skillicons.dev/icons?i=python,js,vscode,html,css,bash,terraform,linux,mysql,mongodb,aws,azure,postman,raspberrypi,jenkins" alt="Languages and Tools" />
                    </a>
                </div>
            `;
            break;
